...
class Stage2Dataset(Dataset):
    def __init__(
            ...
            use_lip_sync_loss=False,    # lip-sync loss flag
            **kwargs):
        super().__init__()
    ...
    def getitem(self, idx):
        ...
        if self.use_lip_sync_loss:
            ...
            # Ensure window_idx is within bounds of precomputed arrays
            ...
            data_dict['lipsync_f_s'] = arr_data['lipsync_f_s'].squeeze(0)  # (32, 16, 64, 64)
            data_dict['lipsync_x_s'] = arr_data['lipsync_x_s'].squeeze(0)  # (21, 3)
            data_dict['lipsync_kp_canonical'] = arr_data['lipsync_kp_canonical'].squeeze(0)  # (63,)
